...
public final class RecipeConditions {
    ...
    public static final RecipeCondition SURFACE_BUILDER_REGISTERED = register("surface_builder", Registry.SURFACE_BUILDER);
    ...
    public static final RecipeCondition BLOCK_STATE_PROVIDER_TYPE_REGISTERED =
            register("block_state_provider_type", Registry.BLOCK_STATE_PROVIDER_TYPE);
    public static final RecipeCondition BLOCK_PLACER_TYPE_REGISTERED = register("block_placer_type", Registry.BLOCK_PLACER_TYPE);
    ...
    private static RecipeCondition register(String id, Registry<?> registry) {
        ...
        return register(id + "_registered", RecipeCondsUtil.stringParam(x -> registry.getIds().contains(new Identifier(x))));
    }
